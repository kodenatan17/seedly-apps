...
import 'package:seedly_app/features/garden/infrastructure/services/remote/garden_remote_service.dart';

@singleton
class GardenRetApiDio extends DioForNative {
  GardenRetApiDio() {
    _configureOptions();
...
@module
abstract class GardenRetrofitInjectableModule {
  GardenRemoteService getGardenRemoteService(GardenRetApiDio client) =>
      GardenRemoteService(client);
}
