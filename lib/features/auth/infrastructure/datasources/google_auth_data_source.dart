...
/// directly, mirroring how [AuthLocalDataSourceImpl] wraps
/// `flutter_secure_storage`.
abstract class GoogleAuthDataSource {
  /// Runs the interactive Google sign-in flow and returns the resulting
  /// OpenID Connect ID token for the backend to verify.
  ///
  /// Throws [GoogleSignInException] (including on user cancellation) —
  /// callers are expected to catch it, same as [AuthRepositoryImpl] does for
  /// [DioException].
