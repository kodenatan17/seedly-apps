...
class ExperienceRetApiDio extends DioForNative {
  ...
  void _configureOptions() {
    ...
    options.receiveTimeout = const Duration(seconds: BaseEnvirontment.receiveTimeout);
...
@module
abstract class ExperienceRetrofitInjectableModule {
  ExperienceRemoteService getExperienceRemoteService(ExperienceRetApiDio client) =>
      ExperienceRemoteService(client);
}
