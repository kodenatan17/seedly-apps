...
@JsonSerializable()
class MissionDetailResponse implements ResponseMapper<MissionDetailEntity> {
  final String id;
  ...
  const MissionDetailResponse({
    ...
    this.completedAt,
    this.objectives = const <MissionObjectiveResponse>[],
